...
parser.add_argument('--classes', type=int, default=100, help='models classes')
...
parser.add_argument('--dataset', type=str, default="cifar100", help="choose from cifar10,svhn,cifar100,Tiny_imagenet")
...
parser.add_argument('--out_dir',type=str,default='./cifar100/results',help='dir of output')
